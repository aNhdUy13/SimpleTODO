...
class AdapterNote(private var noteList: List<com.nda.simpletodo.models.Note>, mContext: CustomCalendarView)
    : RecyclerView.Adapter<AdapterNote.HolderNote>() {

    val mContext: CustomCalendarView = mContext
    ...
    override fun onBindViewHolder(holder: HolderNote, position: Int) {
        holder.itemView.apply {
            ...
            ll_itemNote.setOnClickListener{
                mContext.dialogDetailNote(note,note.nCreatedDate)
            }
